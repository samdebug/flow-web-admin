...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent(null);
        pc.setEntity("com.yzx.flow.common.persistence.model");
        pc.setMapper("com.yzx.flow.common.persistence.dao");
        pc.setXml("com.yzx.flow.common.persistence.dao.mapping");
