...
public interface IBusinessBoardService {
	...
	/**
		 ...
		 * @return
		 */
	List<BusinessBoardInfo> getCustomerTop5(String partnerId);
	...
	/**
		 ...
		 * @return
		 */
	List<BusinessBoardInfo> getPartnerTop5();
	 ...
	 * @return
	 */
	Integer getReadyCount(Integer type, String partnerId);
	 ...
	 * @return
	 */
	Integer getBeenIssuedCount(Integer type, String partnerId);
	 ...
	 * @return
	 */
	Integer getSuccessCount(Integer type, String partnerId);
	 ...
	 * @return
	 */
	Integer getFailCount(Integer type, String partnerId);
	 ...
	 * @return
	 */
	Integer getSumCount(Integer type, String partnerId);
	 ...
	 * @return
	 */
	ReportFormDataInfo createReportFormDataInfo(Integer type, String partnerId);
	...
	/**
		 ...
		 * @return
		 */
	BoardResponseParameterInfo returnAdminOrPartnerData(Integer type, String partnerId, Integer status);
