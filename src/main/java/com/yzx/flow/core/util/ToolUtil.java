...
import com.yzx.flow.core.support.StrKit;
...
//	}
    ...
    public static Boolean getKaptchaOnOff(){
    	...
    	Object attribute = session.getAttribute("errorCount");
    	if(attribute != null){
    		return true;
    	}
    	return false;
//      return SpringContextHolder.getBean(FlowProperties.class).getKaptchaOpen();
    }
     ...
     * @return
     */
    public static String buildSignStr(String sourceStr, String nonceStr, String key) {
    	return MD5Util.encrypt(String.format("%s&&%s@@key=%s", sourceStr, nonceStr, key));
    }
     ...
     * @return
     */
    public static boolean verifySignStr(String sourceStr, String nonceStr, String key, String signStr) {
    	return buildSignStr(sourceStr, nonceStr, key).equalsIgnoreCase(signStr);
    }
}