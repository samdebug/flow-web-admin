package com.yzx.flow.core.shiro.factory;
...
public class ShiroFactroy implements IShiro {
    ...
    public ShiroUser shiroUser(User user) {
        ...
        shiroUser.setType(user.getType()); // 类型
        shiroUser.setTargetId(user.getTargetId());// 目标ID
    ...
    public List<String> getResUrls() {
    	List<String> resUrls = menuDao.getResUrls();
    	return resUrls;
    }
